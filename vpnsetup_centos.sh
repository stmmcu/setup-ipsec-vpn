...
cat 1>&2 <<EOF
Error: Network interface "$NET_IF0" is not available.

DO NOT run this script on your PC or Mac!

If running on a server, you may fix this error by using
'cat /proc/net/dev' to find the active network interface,
